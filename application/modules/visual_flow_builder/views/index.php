...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url(); ?>plugins/flow_builder/css/app.8aa5b967.css" rel="preload" as="style">
        <link href="<?php echo base_url(); ?>plugins/flow_builder/css/chunk-vendors.bff25d1a.css" rel="preload" as="style">
        <link href="<?php echo base_url(); ?>plugins/flow_builder/js/app.f50c9fa0.js" rel="preload" as="script">
        <link href="<?php echo base_url(); ?>plugins/flow_builder/js/chunk-vendors.f9df8098.js" rel="preload" as="script">
        <link href="<?php echo base_url(); ?>plugins/flow_builder/css/chunk-vendors.bff25d1a.css" rel="stylesheet">
        <link href="<?php echo base_url(); ?>plugins/flow_builder/css/app.8aa5b967.css" rel="stylesheet">
    ...
    <body>
        ...
        <script src="<?php echo base_url(); ?>plugins/flow_builder/js/chunk-vendors.f9df8098.js"></script>
        <script src="<?php echo base_url(); ?>plugins/flow_builder/js/app.f50c9fa0.js"></script>
