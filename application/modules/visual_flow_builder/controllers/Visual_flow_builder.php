...
class Visual_flow_builder extends Home
{
    ...
    public function get_dropdown_rcn()
    {
        ...
        $postback_id_list = $this->basic->get_data('otn_postback',array('where'=>array('user_id'=>$this->user_id,'page_id'=>$page_auto_id,'notification_type'=>$rcn_type)),array('id','otn_postback_id','template_name'));
    ...
    public function flowbuilder_submit()
    {
        ...
        $rcn_postback_ids_info = [];
        $postbacks_for_otn_single = [];
        $postbacks_for_rcn_single = [];
        ...
        foreach ($bot_settings_array as $key => $value) {
            ...
            foreach ($reply_bot as $value2) {
                ...
                if(isset($value2['rcn_postback_table_id']))
                {
                    $rcn_postback_ids_info[$value2['rcn_sequence_unique_id']] = $value2['rcn_postback_table_id'];
                    $postbacks_for_rcn_single[$value2['rcn_postback_for_postbacktable']]['rcn_postback_table_id'] = $value2['rcn_postback_table_id'];
                    $postbacks_for_rcn_single[$value2['rcn_postback_for_postbacktable']]['rcn_postback'] = $value2['rcn_postback_for_postbacktable'];
                    unset($value2['rcn_sequence_unique_id']);
                    unset($value2['rcn_postback_table_id']);
                    unset($value2['rcn_postback_for_postbacktable']);
                }
            ...
            if(isset($postbacks_for_rcn_single[$insert_data['postback_id']]))
            {
                $otn_postback_table_id = $postbacks_for_rcn_single[$insert_data['postback_id']]['rcn_postback_table_id'];
                $postback_table_id= $postback_id_table_id_info[$postbacks_for_rcn_single[$insert_data['postback_id']]['rcn_postback']];
                $this->basic->update_data('otn_postback',array("id"=>$otn_postback_table_id),array("reply_postback_id"=>$postback_table_id));
            }
        }
        ...
        foreach($this->new_sequence_information_array as $key_postback=>$new_sequence_campaign)
        {
            ...
            else
            {
                ...
                if(isset($rcn_postback_ids_info[$key_postback]))
                {
                    $otn_postback_table_id = $rcn_postback_ids_info[$key_postback];
                    $this->basic->update_data('otn_postback',array("id"=>$otn_postback_table_id),array("drip_campaign_id"=>$new_sequence_id));
                }
        ...
        foreach ($reply as $single_reply_key => $single_reply_value) 
        {
            ...
            else if($single_reply_value['reply_type'] == 'rcnInput')
            {
                ...
                if($rcn_postback == 'newRcn')
                {
                    ...
                    // $insert_data['otn_postback_id'] = $rcn_campaign_info['new_sequence_information']['xitFbUniqueSequenceId'] ?? '';
                    ...
                    $reply_bot[$single_reply_key]['rcn_postback_for_postbacktable'] = $rcn_campaign_info['postback_id'];
                    $reply_bot[$single_reply_key]['rcn_postback_table_id'] = $rcn_postback;
                    $reply_bot[$single_reply_key]['rcn_sequence_unique_id'] = $rcn_campaign_info['new_sequence_information']['xitFbUniqueSequenceId'] ?? ''; 
                ...
                {       
                    ...
                    $reply_bot[$single_reply_key]['template_type'] = 'Recurring_Notification';             
                    $reply_bot[$single_reply_key]['attachment']['type'] = 'template';
                    $reply_bot[$single_reply_key]['attachment']['payload']['template_type'] = "notification_messages";
                    ...
                    if($user_time_zone[0]['time_zone'] != NULL)
                        $reply_bot[$single_reply_key]['attachment']['payload']['notification_messages_timezone'] = $user_time_zone[0]['time_zone'];
                }
            }
                ...
                if($generic_template_image!="")
                {
                    ...
                    if(function_exists('getimagesize') && $generic_template_image!='') 
                    {
                        ...
                        if($width==$height)
                            ...
                            $reply_bot[$single_reply_key]['attachment']['payload']['image_aspect_ratio'] = 'horizontal';
                    }
    ...
    public function language_file() {
        ...
        var Rcn_name = '<?php echo $this->lang->line("Recurring Notification"); ?>';
        var Rcn_socket_input_reply = '<?php echo $this->lang->line("Reply"); ?>';
        var Rcn_socket_output_next = '<?php echo $this->lang->line("Next"); ?>';
        ...
        var Rcn_single_socket_input_reply = '<?php echo $this->lang->line("Reply"); ?>';
        var Rcn_single_socket_output_next = '<?php echo $this->lang->line("Next"); ?>';
        var Rcn_single_socket_output_next_sequence = '<?php echo $this->lang->line("Sequence"); ?>';
