...
class Instagram_reply extends Home
{
    ...
    {  
      ...
      // $response_raw='{"entry": [{"id": "17841444061670612", "time": 1661242974, "changes": [{"value": {"from": {"id": "6849835938422545", "username": "mostofa.ru"}, "media": {"id": "17971157761538626", "media_product_type": "FEED"}, "id": "18016967611427202", "text": "6"}, "field": "comments"}]}], "object": "instagram"}';
      // $response = json_decode($response_raw,TRUE);

      if(isset($response['entry'][0]['changes'][0]['field']) && $response['entry'][0]['changes'][0]['field'] == 'mentions')
      {
        echo 'mention section'; exit;
        if($this->addon_exist('instagram_reply_enhancers'))
        {
