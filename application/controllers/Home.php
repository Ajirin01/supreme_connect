...
class Home extends CI_Controller
{
    ...
    */
    ...
    function get_facebook_instagram_dropdown($facebook_rx_fb_user_info_id=0, $dropdown_name = "page_id", $dropdown_id = "page_id", $dropdown_style="", $dropdown_class='select2 form-control',$return_groups = false,$social_posting=0) 
    {
        ...
        if($social_posting == 1)
            $page_info = $this->basic->get_data("facebook_rx_fb_page_info",array("where"=>array("facebook_rx_fb_user_info_id"=>$facebook_rx_fb_user_info_id)),array('page_name','id','bot_enabled','has_instagram','insta_username'));
        else
